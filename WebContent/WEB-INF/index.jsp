...
<title>Formula 1 by Leonardo Bianchi</title>
<meta charset="utf-8" />
<meta name="viewport"
...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				<header>
					<h1>Formula 1 by Leonardo Bianchi</h1>
					<h2>the full experience!</h2>
				</header>
				<ul class="actions">
					<li><a href="MainServlet?action=drivers"
						class="button default">Drivers</a></li>
					<li><a href="MainServlet?action=teams" class="button default">Teams</a></li>
				</ul>
			</div>
		</div>
