...
<html>
<head>
<title>${driverSpecific.getName()}&nbsp${driverSpecific.getSurname()}
	- Formula 1 by Leonardo Bianchi</title>
<meta charset="utf-8" />
<meta name="viewport"
...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				<h1>${driverSpecific.getName()}&nbsp${driverSpecific.getSurname()}</h1>
				<span class="image main"><img
					src="${driverSpecific.getImage()}" alt="" /></span>
				<ul>
					<li><b>Racing number:</b> ${driverSpecific.getCarNumber()}
					<li><b>Birthday:</b> ${driverSpecific.getDateOfBirth()}
					<li><b>Country:</b> ${driverSpecific.getCountry()}
					<li><b>Podium finishes:</b> ${driverSpecific.getPodiums()}
					<li><b>Driver championships:</b>
						${driverSpecific.getWorldChampionships()}
					<li><b>Team:</b> ${teamSpecific.getName()}
				</ul>
				<p>
					<a
						href="MainServlet?action=modifyDriver&id=${driverSpecific.getId()}"
						class="button icon solid fa-upload">Modify driver</a>
				</p>
			</div>
		</div>
