...
<html>
<head>
<title>Drivers - Formula 1 by Leonardo Bianchi</title>
<meta charset="utf-8" />
<meta name="viewport"
				...
				<section class="tiles">
					<c:forEach items="${drivers}" var="driver">
						<article class='style6'>
							<span class='image'> <img src=${driver.getImage() } alt='' /></span><a
								href='MainServlet?action=driverSpecific&id=${driver.getId()}'>
								<h2>${driver.getName()}&nbsp${driver.getSurname()}</h2>
								<div class='content'>
									<p>#${driver.getCarNumber()}</p>
								</div>
							</a>
						</article>
					</c:forEach>
